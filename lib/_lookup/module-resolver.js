...
class ModuleResolver {
     ...
     */
    static resolve(name, extraLookupPath) {
        return defaultResolver.resolve(name, extraLookupPath); // eslint-disable-line no-use-before-define
    }
...
const defaultResolver = new ModuleResolver();
